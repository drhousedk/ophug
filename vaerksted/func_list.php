...
echo "<table>";
echo "<tr bgcolor='#333333'><td><b>Stamnr</b></td><td><b>Bil</b></td><td><b>Reservedel</b></td><td><b>Besked</b></td><td><b>Varetur</b></td><td><b>Status</b></td><td><b>Ekspedient</b></td><td><b>Mekaniker</b></td><td><b>Bestilt</b></td><td><b>Tag opgave</b></td><td><b>Meld klar</b></td><td><b>Note</b></td><td><b>Print</b></td><td><b>Billede</b></td></tr>";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    if ($status == "Bestilt") {
        ...
        echo "</td><td></td><td>" . $note . "</td><td><center><a href='/print.php?id=" . $id . "' target='_blank'><img src='/images/printer32.png' height='20px' /></a></center></td><td>$imglink</td></tr>";
...
<form name='klar' method='post' action='klar_do.php?id=" . $id . "'><input type='submit' value='Meld klar!'><!--<a href=klar_do.php?id=" . $id . ">Meld klar</a>--></td><td><input type='text' name='note'></form></td><td><center><a href='/print.php?id=" . $id . "' target='_blank'><img src='/images/printer32.png' height='20px' /></a></center></td><td>$imglink</td></tr>";
    } else {
...
" . $note . "</td><td><center><a href='/print.php?id=" . $id . "' target='_blank'><img src='/images/printer32.png' height='20px' /></a></center></td><td>$imglink</td></tr>";
